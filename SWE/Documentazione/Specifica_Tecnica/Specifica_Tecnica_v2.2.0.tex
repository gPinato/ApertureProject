...
\immagine{./Diagrammi/SequenzaSuccesso}{Diagramma sequenza: Modifica View con successo}
Il diagramma precedente illustra la sequenza di operazioni che avviene alla modifica della view da parte dell'utente terminata con successo.

\subsection{Modifica della View con insuccesso}
\immagine{./Diagrammi/SequenzaErrore}{Diagramma sequenza: Modifica View con insuccesso}
Il diagramma precedente illustra la sequenza di operazioni che avviene alla modifica della view da parte dell'utente terminata con un errore.
