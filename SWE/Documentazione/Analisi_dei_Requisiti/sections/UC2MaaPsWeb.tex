...
L'utente business autenticato può effettuare la ricerca di una Collection attraverso la barra di ricerca (UC2.8).
}
\post
...
L'utente business autenticato amministratore può gestire le query più frequenti che il sistema gli propone (UC2.4.6);|
L'utente business autenticato amministratore può gestire degli indici sulle query più frequentemente visualizzate (UC2.4.7).
}
\post
...
{Caso d'uso UC2.4.6}
{Gestione query}
\UCimmagine{UC2.4.6}{UC2.4.6 - Gestione query}
\UC
{UC2.4}
{Utente business autenticato amministratore}
{L'utente business autenticato amministratore può gestire le query più utilizzate che il sistema gli offre}
{Il sistema reputa l'utente business autenticato come amministratore}
\scenario
{L'utente business autenticato amministratore può visualizzare le query più utilizzate (UC2.4.6.1);|
L'utente business autenticato amministratore può creare un indice (UC2.4.6.2);|
L'utente business autenticato amministratore può visualizzare il comando per la creazione dell'indice da riga di comando (UC2.4.6.3).
}
\post
{Il sistema mostra all'utente business autenticato amministratore le query più utilizzate e conferma la creazione di un indice se effettuata}

\UCtitle
{Caso d'uso UC2.4.6.1}
{Visualizzazione query più utilizzate}
\UC
{UC2.4.6}
{Utente business autenticato amministratore}
{L'utente business autenticato amministratore può visualizzare le query più utilizzate che il sistema mette a disposizione}
{Il sistema reputa l'utente business autenticato come amministratore}
\scenario
{L'utente business autenticato amministratore può visualizzare le query più utilizzate.}
\post
{Il sistema mostra le query più utilizzate}

\UCtitle
{Caso d'uso UC2.4.6.2}
{Creazione indice}
\UC
{UC2.4.6}
{Utente business autenticato amministratore}
{L'utente business autenticato amministratore può creare un indice sulle query più utilizzate che il sistema mette a disposizione}
{Il sistema reputa l'utente business autenticato come amministratore}
\scenario
{L'utente business autenticato amministratore può creare un indice.}
\post
{Il sistema conferma l'avvenuta creazione dell'indice}

\UCtitle
{Caso d'uso UC2.4.6.3}
{Visualizzazione comando creazione indice}
\UC
{UC2.4.6}
{Utente business autenticato amministratore}
{L'utente business autenticato amministratore può visualizzare il comando per la creazione di un indice da riga di comando}
{Il sistema reputa l'utente business autenticato come amministratore}
\scenario
{L'utente business autenticato amministratore può visualizzare il comando per la creazione dell'indice da riga di comando.}
\post
{Il sistema mostra il comando per la creazione dell'indice da riga di comando}
...
{UC2.4.7}
{Utente business autenticato amministratore}
{L'utente business autenticato amministratore visualizzare gli indici creati sulla base delle query più utilizzate e l'eliminazione degli indici già presenti nel sistema}
{Il sistema reputa l'utente business autenticato come amministratore}
\scenario{
L'utente business autenticato amministratore può eliminare degli indici (UC2.4.7.1);|
L'utente business autenticato amministratore può visualizzare degli indici (UC2.4.7.2).
}
\post
{Il sistema ha visualizzato gli indici o eliminato un indice esistente come richiesto dall'utente business autenticato amministratore}
...
{UC2.4.7}
{Utente business autenticato amministratore}
{L'utente business autenticato amministratore può eliminare un indice tra quelli che il sistema mostra.}
{Il sistema reputa l'utente business autenticato come amministratore e visualizza una lista di indici}
\scenario
{L'utente business autenticato amministratore può eliminare degli indici.}
\post
{Il sistema ha ottentuo l'informazione riguardo all' indice che l'utente business autenticato amministratore vuole cancellare}
...
{Caso d'uso UC2.8}
{Ricerca Collection}
\UCimmagine{UC2.8}{UC2.8 Ricerca Collection}
\UC
{UC2}
{Utente business autenticato}
{L'utente business autenticato può ricercare una Collection inserendo il nome della Collection nella barra di ricerca}
{Il sistema reputa l'utente business come autenticato}
\scenario
{L'utente business autenticato può aprire una pagina Collection (UC 2.4).}
\post
{Il sistema ha visualizzato la Collection che l'utente business autenticato ha richiesto}
