...
\newcommand{\TipoDocumento}{Manuale Utente}	 	%tipo documento
...
\begin{abstract}
\begin{center}
Manuale utente dell'applicazione \Progetto{}.
\end{center}
\end{abstract}
...
Questo documento rappresenta il manuale utente per l'applicazione \gloss{MaaP} nel quale vengono descritte dettagliatamente tutte le caratteristiche dell'applicativo utilizzabili dall'utente. Tale manuale è suddiviso in sezioni a seconda delle diverse funzionalità presenti.
