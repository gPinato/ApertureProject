...
\elemento{Stub}
{Porzione di \gloss{codice} utilizzata in sostituzione di altre funzionalità \gloss{software}. Uno stub può simulare il comportamento di \gloss{codice esistente}, gli stub sono utili durante lo sviluppo di software e durante i test per i software.}
