...
\item \grassetto{Package: } Identifica la gerarchia di package di cui il modulo fa parte. La gerarchia dovrà essere espressa dal package più grande al più piccolo, separando i nomi con :: ;
