...
\begin{description}
 \item[Descrizione] \hfill \\
 %questa è strana perché ritorna solo la $resource e non dichiara metodi di dialogo con il server.
 %però ora devo scappare, riprendo da qui appena possibilie.
 \item[Utilizzo] \hfill \\
