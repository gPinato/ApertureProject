...
\newcommand{\DataUltimaModifica}{2014-03-28}
...
\label{1.1}
Il presente documento ha l'obiettivo di definire la pianificazione secondo la quale saranno scadenziati i lavori dal gruppo Aperture \gloss{Software} sul progetto \Progetto{}.
...
\item Ad esclusione di uno dei componenti, il gruppo possiede una connessione permanente alla rete internet. Per sopperire alle mancanze di connessione o a problemi individuali, l'attuazione delle attività è concentrata nelle ore di apertura dei laboratori informatici, forniti di connessione intenet.
\item 
\end{itemize}
