...
%definizione del nuovo environment per avere definizioni su più righe
...
\newcommand{\Prodotto}{
Lo scopo del prodotto è produrre un \gloss{framework} per generare interfacce web di amministrazione dei dati di business basato sullo stack \gloss{\Nodejs{}} e \gloss{\mongodb{}}.\\
L'obiettivo è quello di semplificare il lavoro allo \gloss{sviluppatore} che dovrà rispondere in modo rapido e standard alle richieste degli esperti di \gloss{business}.
}
