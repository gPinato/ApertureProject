...
L'utente business autenticato può eliminare il Document che sta visualizzando (UC2.4.1.2);|
L'utente business autenticato può modificare il Document che sta visualizzando (UC2.4.1.3).
}
\post
...
{L'utente business autenticato può modificare il Document che sta visualizzando.}
\post
{Il sistema permette all'utente di modificare il Document che sta visualizzando}
