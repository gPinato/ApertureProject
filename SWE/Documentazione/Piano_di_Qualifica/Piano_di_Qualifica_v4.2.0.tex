...
\item Numero di messaggi di errore(vedi sezione ???) MI SA CHE E' DA TOGLIERE;
\item Numero di esecuzioni andate a buon fine(vedi sezione 4.2.5 di questo documento).
\end{itemize}
\end{itemize}
\item \grassetto{Efficienza}: il prodotto software deve consumare le risorse in maniera adeguata e ridurre al minimo i tempi di attesa o i tempi di risposta per un qualsiasi risultato; DA TOGLIERE SE NON CI SONO IDEE
\begin{itemize}
\item \grassetto{Strategia adottata}: TOGLIERE
\item \grassetto{Misura o metrica utilizzata}: TOGLIERE
\end{itemize}
...
\item \grassetto{Misura o metrica utilizzata}:
\begin{itemize}
\item Lunghezza manuale utente(vedi sezione 4.2.6 di questo documento); VEDERE SE E' DA TOGLIERE
\item Numero di messaggi di errore(vedi sezione ???);DA TOGLIERE
\end{itemize} 
\end{itemize}
...
\begin{itemize}
\item Parametri per metodo(vedi sezione 4.2.10 di questo documento);
\item Soddisfacimento requisiti prestazionali e di vincolo(vedi sezione???); DA TOGLIERE
\item Linee di codice per metodo(vedi sezione 4.2.3 di questo documento);
\end{itemize}
\end{itemize}
\end{itemize} 
...
\subsection{Prodotto Efficiente} DA TOGLIERE
...
\subsubsection{Numero messaggi di errore} DAT TOGLIERE
\begin{itemize}
...
\subsubsection{Attributi per \gloss{classe}}DA TOGLIERE
\label{4.2.3}
