...
%\paragraph{Gestione di configurazione}
%\paragraph{Gestione della qualità}
%\paragraph{Risoluzione dei problemi} %(?)
%
%\subsection{Processi organizzativi}
%\paragraph{Gestione}
%\paragraph{Infrastrutture}
%\paragraph{Miglioramento}
%\paragraph{Training}

\subsection{Processi primari}
\subsubsection{Gestione di progetto}
Questo processo comprende tutte le attività volte gestire la pianificazione, le risorse, i rischi e AGGIUNGERE
...
Questo processo comprende tutte le attività volte a verificare che i processi precedentemente applicati non abbiano introdotto errori e che il prodotto finale sia coerente con il risultato atteso.
