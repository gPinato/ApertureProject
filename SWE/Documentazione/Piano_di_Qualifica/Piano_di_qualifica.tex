...
\begin{itemize}
\item \grassetto{Analisi:} si seguono i metodi di Verifica descritti nelle Norme di Progetto sui documenti prodotti e i processi attuati. La messa in opera di tali tecniche è descritta nell'appendice sezione B.1.1
\item\grassetto{Analisi di Dettaglio:} si verificano i processi che determinano l'incremento dei documenti redatti per il precedente periodo di Analisi, e si verificano i prodotti generati dai relativi processi, seguendo le Norme di Progetto. La messa in opera di tale attività è descritta nell'appendice sezione B.1.2
...
\newpage
\section{Tecniche di analisi} %3.0
\label{3.0}
...
Durante l'utilizzo della tecnica di Walkthrough la lista verrà aggiornata; la lista risultante è in appendice delle Norme di Progetto.
