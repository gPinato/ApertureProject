...
\immagine{./tabelle/differenza_ruoli_validazione}{Costo per ruolo, fase di Pre RA}

Nella tabella seguente sono riportate le differenze tra le ore di lavoro previste per ogni componente con quelle realmente impiegate.

\immagine{./tabelle/differenza_preventivo_consuntivo_validazione}{Differenza preventivo consuntivo per componente, fase di Pre RA}
...
\immagine{./tabelle/costo_consuntivo}{Differenza preventivo consuntivo totale per ruolo}
Il grafico seguente mostra la differenza tra le ore pianificate e le ore realmente impiegate, per ciascun ruolo nelle fasi rendicontate: \grassetto{Pre RP, Pre RQ, Pre RA}.
\immagine{./tabelle/costo_consuntivo_grafico}{Differenza preventivo consuntivo totale}
Nella tabella seguente sono riportate le differenze tra le ore di lavoro previste per ogni componente con quelle realmente impiegate.

\immagine{./tabelle/differenza_preventivo_consuntivo_ore}{Differenza preventivo consuntivo per componente totale}

\immagine{./tabelle/ore_consuntivo_grafico}{Ore impiegate da ciascun componente}
