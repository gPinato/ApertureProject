...
\end{itemize}
Tramite l'utilizzo di un linguaggio astratto \gloss{DSL}, il prodotto permetterà all'\gloss{utente} di generare due tipi di pagine:
\begin{itemize}
...
Inoltre sarà possibile, attraverso un menù, di selezionare la Collection che si desidera visualizzare.

\subsection{Caratteristiche degli utenti}
\label{2.3}
Il prodotto MaaP si rivolge ad una sola tipologia di utenti che possiedono alte competenze tecniche, nello specifico sviluppatori e/o esperti in amministrazione di \gloss{database}.
Non emerge quindi il \gloss{requisito} di aver alcuna gerarchia di utenti o con privilegi differenziati.
