...
Fornisce un immediato elenco delle collection disponibili.
 ...
 \item[Funzionalità]
 \begin{mldescription}
  \mlitem{CollectionListService.get(function success(data) \{
...
\begin{description}
 ...
 \begin{description}
  \item[init()] \hfill 
  	\begin{description}
  		\item[Descrizione] \hfill \\
  		Funzione di inizializzazione del CollectionController. Imposta i valori iniziali delle variabili dello \$scope associate alla Collection view ed esegue la funzione \emph{getData()}.
  	\end{description}
