...
\newpage
\subsubsection{MaaP Sviluppatore}
\immagine{./Diagrammi/Installer}{Diagramma delle classi relativo alla gestione del framework da parte dell'utente svilupatore}
