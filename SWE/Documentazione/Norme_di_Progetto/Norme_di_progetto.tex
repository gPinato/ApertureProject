...
\subsection{Email}
\label{3.1}
La \gloss{email} ufficiale del gruppo è \textbf{\url{ApertureSWE@gmail.com}}.\\
...
Le comunicazioni riguardanti dubbi o chiarimenti marginali o comunque non inerenti all'organizzazione del gruppo, vengono definiti informali. Per loro natura, queste comunicazioni devono essere veloci e non complesse, quindi abbiamo deciso di utilizzare strumenti immediati di comunicazione, quali le \glossary{chat}. In questo caso, un membro del gruppo esprime il dubbio come messaggio istantaneo, il quale sarà visibile da ogni altro componente. 
