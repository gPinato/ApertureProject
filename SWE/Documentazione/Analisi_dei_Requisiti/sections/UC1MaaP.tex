...
\post{Il sistema ha aggiornato la definizione della visualizzazione del menù con le modifiche apportate dall'utente sviluppatore}
...
{UC1.2.2.2}
{Utente sviluppatore}
{L'utente sviluppatore  può modificare varie impostazioni della definizione della visualizzazione della pagina Collection-Index}
