...
Ogni \gloss{email} inviata a tale indirizzo verrà inoltrata alla email personale di ogni \gloss{componente} nel gruppo.
...
\subsubsubsection{Gruppo \gloss{Facebook}}
...
Per realizzare i diagrammi \gloss{UML} dei casi d'uso è stato scelto Astah. Il software era stato consigliato dal Professor Cardin e soddisfa tutte le necessità del team.
...
\item \grassetto{Classi: }specifica se il componente ha eventuali classi; se c'è una \gloss{classe} deve essere scritta secondo la struttura definita nella successiva sezione.
\end{itemize}
...
Gli sviluppatori dovranno attenersi alle comuni Coding Conventions, in particolare a quelle suggerite dal Prof. Crockford nel suo \gloss{sito \gloss{web}}.\footnote{http://javascript.crockford.com/code.html}\\
...
\item Ticket per \gloss{pianificare} attività;
...
\subsubsubsection{\gloss{Google Drive}}
