...
\begin{abstract}
\begin{center}
Questo documento si propone di presentare l'analisi dei requisiti che il prodotto \Prodotto{} dovrà rispettare, individuati a partire dal capitolato d'appalto del Proponente \Prop{}.
\end{center}
\end{abstract}
...
\midrule
2.1.0 & 2014-01-02 & Fabio Miotto (VE) & Verifica documento\\
\midrule
2.0.2 & 2014-12-30 & Alessandro Benetti (AN) & Aggiornato tracciamento\\
\midrule
