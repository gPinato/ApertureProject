...
\item File di configurazione necessari al funzionamento dell'applicazione nella loro versione predefinita;
\item Sistema di autenticazione;
\item Directory di descrizione pagine web.
\end{itemize}
Tramite l'utilizzo di un linguaggio astratto DSL, il prodotto permetterà all'utente di generare due tipi di pagine:
\begin{itemize}
...
\item Selezionare, per ogni documento, una chiave che rimanderà alla relativa pagina di tipo Document-show.
\end{itemize}
