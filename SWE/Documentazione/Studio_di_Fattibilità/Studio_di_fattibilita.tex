...
\label{2}
Il capitolato proposto da CoffeeStrap propone di sviluppare un \gloss{framework} ad alto livello che permetta la facile creazione di pagine \gloss{web} per la visualizzazione e la modifica di dati provenienti da \gloss{MongoDB}.
