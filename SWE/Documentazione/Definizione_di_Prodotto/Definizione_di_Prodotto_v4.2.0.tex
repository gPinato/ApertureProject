...
Per ultima cosa, il \textit{dispatcher} gestisce eventuali richieste di risorse inesistenti o errate reindirizzando il chiamante alla pagina iniziale del Client AngularJS.
 ...
 \begin{itemize}
  ...
  \item get('/api/collection/:col\_id', passport.checkAuthenticated, datamanager.sendCollection);
  \item get('/api/collection/:col\_id/:doc\_id', passport.checkAuthenticated, datamanager.sendDocument);
  \item get('/api/collection/:col\_id/:doc\_id/edit', passport.checkAuthenticatedAdmin, datamanager.sendDocumentEdit);
  \item put('/api/collection/:col\_id/:doc\_id/edit', passport.checkAuthenticatedAdmin, datamanager.updateDocument);
  \item delete('/api/collection/:col\_id/:doc\_id/edit', passport.checkAuthenticatedAdmin, datamanager.removeDocument);
 \end{itemize}
 ...
 \begin{itemize}
 	\item init(): accetta app (l'applicazione di Express) come parametro, si occupa dell'inizializzazione del \textit{dispatcher}. 
 \end{itemize}
 \end{description}
\end{description}
