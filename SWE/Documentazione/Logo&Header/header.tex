...
\newcommand{\Prodotto}{
Lo scopo del prodotto è produrre un \gloss{framework} per generare interfacce web di amministrazione dei dati di business basati sullo stack \gloss{\Nodejs{}} e \gloss{\mongodb{}}.\\
