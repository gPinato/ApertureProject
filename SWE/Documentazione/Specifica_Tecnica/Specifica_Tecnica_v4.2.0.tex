...
\subsection{Express}
Express è un framework minimale e flessibile per la creazione di applicazioni web basate su Node.js, contiene una varietà di funzioni sia per la creazione di applicazioni a singola pagina che multi-pagina oltre che applicazioni ibride.
...
\item \gloss{Dependency Injection}: AngularJS dispone di uno strumento di dependence injection, che aiuta gli sviluppatori facilitando la creazione, la comprensione e il \gloss{testing} dell'applicazione.
