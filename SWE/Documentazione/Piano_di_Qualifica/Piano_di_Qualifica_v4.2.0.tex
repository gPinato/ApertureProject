...
Per la portabilità del prodotto, verrà prodotta una tabella di tracciamento. Questa serve per identificare i requisiti di vincolo individuati nell'Analisi dei Requisiti. Per assicurarsi maggior portabilità dovranno essere soddisfatte le tipologie di requisiti indicate.
