 ...
 \begin{description}
  \item[Parametri] \hfill
   \begin{mldescription}
    \mlitem{'/loggedin'}
    Stringa contenente l'indirizzo della API da richiamare.
    \mlitem{function(req, res) \{ res.send(req.isAuthenticated() ? req.user : '0'); \}}
 ...
 \begin{description}
  \item[Parametri] \hfill
   \begin{mldescription}
    \mlitem{'/api/login'}
    Stringa contenente l'indirizzo della API da richiamare.
    \mlitem{passport.checkNotAuthenticated}
    Funzione di \textit{@passport} che verifica che l'utente non sia autenticato.
    \mlitem{passport.authenticate}
    Funzione di \textit{@passport} che esegue l'autenticazione.
    \mlitem{function(req, res) \{ res.send(req.user); \}}
 ...
 \begin{description}
  \item[Parametri] \hfill
   \begin{mldescription}
    \mlitem{'/api/logout'}
    Stringa contenente l'indirizzo della API da richiamare.
    \mlitem{passport.checkAuthenticated}
    Funzione di \textit{@passport} che verifica che l'utente sia autenticato.
    \mlitem{function(req, res) \{ req.logout(); res.send(200); \}}
 ...
 \begin{description}
  \item[Parametri] \hfill
   \begin{mldescription}
    ...
    \mlitem{function(req, res) \{ res.sendfile(path.join(config.static\_assets.dir, 'index.html')); \}}
