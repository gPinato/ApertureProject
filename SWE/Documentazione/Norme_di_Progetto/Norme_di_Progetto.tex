...
All'inizio di ciascuna delle fasi delineate nel \emph{Piano di Progetto v4.2.0}, il Responsabile di Progetto deve realizzare un \gloss{diagramma di \gloss{Gantt}} su \gloss{Redmine}, come descritto in sezione XXX di questo documento, per tracciare e gestire le attività dei processi utilizzati dal progetto.
...
Durante la scrittura della documentazione i redattori dovranno strettamente attenersi a tutte le norme definite nell'appendice XXX %ammaccabanane
