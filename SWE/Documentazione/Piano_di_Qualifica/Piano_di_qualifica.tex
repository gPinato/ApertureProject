...
\textbf{Redazione} & Mattia Sorgato, Fabio Miotto,\\			%CAMBIARE QUI
& Michele Maso, Giacomo Pinato, Andrea Perin, Alberto Garbui\\
\textbf{Verifica} & Fabio Miotto, Alessandro Benetti, Andrea Perin\\%ED ANCHE QUI!
\textbf{Approvazione} & Giacomo Pinato, Alberto Garbui, Fabio Miotto\\				%CAMBIARE QUI
...
\midrule
3.1.1 & 2014-03-24 & Alessandro Benetti (VE) & Verifica documento.\\
\midrule
3.1.0 & 2014-03-21   & Andrea Perin (VE) & Verifica documento.\\
\midrule
3.0.5 & 2014-03-19	& Mattia Sorgato (VE) & Resoconto attività di verifica.\\
\midrule
3.0.4 & 2014-01-17 	& Alberto Garbui (VE) & Aggiunta analisi RR documento.\\
\midrule
3.0.3 & 2014-01-16 	& Fabio Miotto (AN) & Aggiunta analisi RR documento.\\
\midrule
3.0.2 & 2014-02-28 	& Michele Maso (PR) & Incremento documento con progettazione test.\\
\midrule
...
\midrule
2.1.0 & 2014-01-06 & Fabio Miotto (VE) & Verifica documento.\\
\midrule
2.0.2 & 2014-01-04 & Andrea Perin (VE) & Esito metriche processi.\\
\midrule
2.0.1 & 2014-01-04  & Andrea Perin (VE) & Esito metriche documenti.\\    
\midrule
...
\item \grassetto{Strategie proattive: }l'insieme delle strategie proattive, le cui procedure sono descritte nelle Norme di Progetto, permettono di garantire qualità a tempo zero, limitando attività di verifica che hanno un costo non indifferente.
...
\subsubsubsection{Livelli di annidamento}
\label{4.2.2}
...
\subsubsubsection{Attributi per classe}
\label{4.2.3}
Il numero di attributi per \gloss{classe} esprime, appunto, la quantità di proprietà di una classe. Un elevato numero di attributi può denotare un'eccessiva dimensione della classe stessa, che potrebbe piuttosto essere suddivisa in classi più piccole, relazionate tra di loro.
...
\subsubsubsection{Parametri per metodo}
\label{4.2.4}
...
\subsubsubsection{Linee di codice per linee di commento}
\label{4.2.5}
...
\subsubsubsection{Flusso di informazioni}
\label{4.2.6}
...
\subsubsubsection{Accoppiamento}
\label{4.2.7}
Si divide in due categorie:
\begin{itemize}
\item \grassetto{Accoppiamento afferente}: questo valore indica la quantità di di classi esterne ad un \gloss{package} che dipendono da classi interne allo stesso.
