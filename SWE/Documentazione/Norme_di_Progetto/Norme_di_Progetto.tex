...
\begin{itemize}
\item \grassetto{Nome: }specifica il nome del  modulo/classe, in cui tra parantesi si mette se è astratta oppure no; il nome di ciascuna classe deve essere scritto secondo la seguente notazione: E1::E2::E3::E4::E5;la struttura è la seguente:
\begin{itemize}
