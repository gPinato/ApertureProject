...
\item \grassetto{Piano di Qualifica}: \emph{Piano_di_Qualifica_v1.2.0};
\item \grassetto{Piano di Progetto}: \emph{Piano_di_Progetto_v1.2.0}.
\end{itemize}
...
\label{2.5}
Il Verificatore è responsabile delle attività di Verifica. Ha il compito di assicurare che i documenti e il \gloss{codice} rispettino gli standard stabiliti nelle \emph{Norme_di_ Progetto_v1.2.0}.
