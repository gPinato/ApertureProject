...
\begin{itemize}
\item \grassetto{Funzionalità}: il prodotto software deve soddisfare tuti i requisiti funzionali, tutti i requisiti obbligatori trovati e di conseguenza fornire le funzionalità attese;
\begin{itemize}
...
\begin{itemize}
\item \grassetto{Strategia adottata}: Testo leggibile(vedi sezione???).
...
Per quanto riguarda la manutenibilità del prodotto, ogni volta che verranno progettate delle componenti si procederà al calcolo dell'accoppiamento afferente ed efferente; dopodichè si procede al calcolo dell'instabilità cercando di rientrare nel valore ottimale corrispondente. Inoltre prima di effettuare un commit, ogni pezzo di codice scritto deve soddisfare le metriche individuate.
