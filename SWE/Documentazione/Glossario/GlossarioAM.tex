...
\elemento{MVC}
{Acronimo di Model View Controller; è un pattern architetturale molto diffuso nello sviluppo di sistemi software, in particolare nell'ambito della \gloss{programmazione orientata agli oggetti}, in grado di separare la logica di presentazione dei dati dalla \gloss{logica di business}}
