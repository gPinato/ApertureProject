...
var temp = angular.module('angularyoApp.services',
    ['ngResource']);


temp.factory('firstservice',function(){
    var rows= [{
...
angular.module('angularyoApp',['ngResource']).factory('firstservice',['$resource', function($resource) {
    var rows= [{
        id: 0, sender: 'jean@somecompany.com', subject: 'Hi there, old friend',
        date: 'Dec 7, 2013 12:32:00', recipients: ['greg@somecompany.com'],
        message: 'Hey, we should get together for lunch sometime and catch up.'
