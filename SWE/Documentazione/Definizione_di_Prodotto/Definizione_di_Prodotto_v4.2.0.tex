...
Per ultima cosa, il \textit{dispatcher} gestisce eventuali richieste di risorse inesistenti o errate reindirizzando il chiamante alla pagina iniziale del Client AngularJS.
 ...
 \begin{description}
  ...
  Intercetta la richiesta di generare l'elenco delle Collection verificando che essa sia autenticata e richiama il metodo sendCollectionsList del modulo datamanager.
  \item[get('/api/collection/:col\_id', passport.checkAuthenticated, datamanager.sendCollection);]\hfill \\   Intercetta la richiesta di generare l'elenco dei Document all'interno di una Collection. 
