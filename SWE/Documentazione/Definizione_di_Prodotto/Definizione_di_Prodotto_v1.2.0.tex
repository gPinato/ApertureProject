...
\begin{description}
 ...
 \begin{description}
  ...
  pubblicizzata da UserEditService fornendo come argomenti l'identificativo della Collection correntemente visualizzata e l'indice del Document da eliminare. \\
  Se l'eliminazione ha successo viene lanciato l'aggiornamento della vista corrente con il Document eliminato, altrimenti si  richiama la callback di errore.
    \end{description}
...
\begin{description}
 ...
 \begin{description}
  ...
  \begin{description}
  	\item[Parametro]
  		\begin{mldescription}
  			\mlitem user\_id: \$routeParams.user\_id.
       \end{mldescription}
  	\item[Descrizione] \hfill \\
