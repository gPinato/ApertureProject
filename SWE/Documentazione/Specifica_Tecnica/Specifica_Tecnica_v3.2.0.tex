...
\item \gloss{Dependency Injection}: AngularJS possiede nativamente una "dependency injection", che aiuta gli sviluppatori facilitando la creazione, la comprensione e il \gloss{testing} dell'applicazione.
