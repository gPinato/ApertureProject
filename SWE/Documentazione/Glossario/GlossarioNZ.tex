...
{Sistema che gestisce un processo tramite il quale un computer, un \gloss{software} o un \gloss{utente}, verifica le corrette, o presunte, credenziali di un altro computer, utente, che vuole comunicare attraverso una connessione.}
