...
\midrule
3.0.8 & 2014-03-19 & Giacomo Pinato (PR) & Resoconto attività PDCA.\\
\midrule
3.0.7 & 2014-03-12 & Giacomo Pinato (PR) & Aggiunta test di validazione e tracciamento.\\
\midrule
3.0.7 & 2014-03-12 & Mattia Sorgato (PR) & Aggiunta test di integrazione e tracciamento.\\
\midrule
...
\item \grassetto{Verifica}: è la valutazione che un prodotto, \gloss{servizio} o sistema è conforme a regole, requisiti, specifiche o condizioni imposte. È spesso un processo interno e differisce dalla validazione. In analogia, l'attività di Verifica deve rispondere alla domanda: `` did i built the system right?'', ovvero ``ho costruito il sistema in modo corretto?'';
