...
\subsubsection{TV 5 - Lato Utente Sviluppatore}
...
\item Verificare di poter gestire il progetto;
\begin{enumerate}
...
Di seguito verranno riportati in forma tabellare i tracciamenti requisiti - test di validazione.\\
\subsubsection{Tracciamento componente-test d'integrazione}
\begin{center}
\begin{longtable}{|p{7cm}|p{7cm}|}
\toprule
