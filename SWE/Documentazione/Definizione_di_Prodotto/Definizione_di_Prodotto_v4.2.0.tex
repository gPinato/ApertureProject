...
%prego Iddio che questo metodo venga modificato, altrimenti c'e' da spararsi. fatemi sapere.	
		...
		\begin{description}
			\item[Dipendenza] \hfill
				\begin{itemize}
					...
					%questo e' da vedere. importo un JSON che e' generato dal DSL. come faccio a distiguerlo
					%dagli altri moduli o package??					
	...
	%applyTransformations devo farmelo spiegare, perche' non l'ho capito.
	...
	\mlitem{updateDocument(collection\_name, document\_id, newDocumentData, callback)} \hfill 
		\begin{description}
			\item[Parametri] \hfill
				\begin{description}
					\item[collection\_name] \hfill
...
%DA CONTROLLARE, NON VORREI AVER SCRITTO UNA CAPPELLA					
