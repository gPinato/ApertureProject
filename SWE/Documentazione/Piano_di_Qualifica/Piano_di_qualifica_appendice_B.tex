...
\midrule
TS1 & Viene verificato che il sistema MaaP generi correttamente lo scheletro necessario al funzionamento & ROF1 & D.E \\
\midrule
TS1.1 & Viene verificato che il sistema MaaP installi correttamente le librerie necessarie al funzionamento & ROF1.1 & D.E \\
\midrule
TS1.2 & Viene verificato che il sistema MaaP generi correttamente i file necessari al funzionamento & ROF1.2 & D.E \\
\midrule
TS1.3 & Viene verificato che il sistema MaaP generi correttamente le directory necessarie al funzionamento & ROF1.3 & D.E\\
\midrule
TS1.4 & Viene verificato che il sottosistema di autenticazione sia installato e configurato correttamente & ROF1.4 & D.E\\
\midrule
TS1.4.1.1 & Viene verificato che nel database degli utenti sia presente un profilo di amministrazione di default & ROF 1.4.1 & D.E\\
\midrule
TS4 & Viene verificato che il sistema crei correttamente le pagine web partendo dal loro file di descrizione & ROF 4.1 & D.E\\
\midrule
TS5.1 & Viene verificato che la funzione di registrazione possa essere correttamente abilitata/disabilitata & RDF5.1 & D.E\\
\midrule
TS5.4 & Viene verificato che il sistema possa correttamente cambiare database di analisi & ROF5.4 & D.E\\
\midrule
...
\midrule
TS10.2 & Viene verificato che il sistema visualizzi correttamente le pagine di Document-Show & ROF10.1 & D.E\\
\midrule
TS10.2.4 & Viene verificato che il sistema disconnetta correttamente un utente alla sua richiesta & ROF10.2.4 & D.E\\
\midrule
TS10.3.1 & Viene verificato che le modifiche apportate al profilo di un utente business autenticato siano consistenti & ROF10.3.1 & D.E\\
\midrule
...
\midrule
TS10.4 & Viene verificato che l'utente business autenticato amministratore possa modificare correttamente un Document & ROF10.4 & D.E\\
\midrule
TS10.5 & Viene verificato che l’utente business autenticato amministratore possa eliminare correttamente un Document & ROF10.5 & D.E\\
\midrule
...
\midrule
TS19 & Viene verificato che il sistema accetti solo file di configurazione che validi & ROV19 & D.E\\
\midrule
