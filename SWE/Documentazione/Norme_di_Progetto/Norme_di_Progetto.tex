...
\end{itemize}
\paragraph{Tracciamento requisiti-classi}
La tabella del tracciamento avrà la seguente forma:
\begin{itemize}
\item \grassetto{Requisiti: }specifica i requisiti;
\item \grassetto{Classe: }specifica il nome della classe.
...
\subparagraph{Gestione dei conflitti} nel caso si verifichino conflitti sarà necessario usare il comando \textit{git mergetool} e risolvere il conflitto tramite l'apposito tool.
