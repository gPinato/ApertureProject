...
\elemento
{Oggetto software}
{Definito come un tipo di dato astratto, un oggetto è un insieme di valori ed operazioni che permettono di manipolare tali valori, dette operazioni proprie del \gloss{tipo} o metodi del \gloss{tipo}.}
