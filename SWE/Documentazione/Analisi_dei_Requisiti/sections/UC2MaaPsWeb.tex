...
{Il sistema ha creato lo scheletro del progetto, la pagina di autenticazione viene proposta all'utente business mediante il browser, se il sistema reputa l'utente business come autenticato, viene proposta la \gloss{dashboard}}
\scenario{
