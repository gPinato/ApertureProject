%QUESTE TABELLE SONO STATE GENERATE AUTOMATICAMENTE DA TRACCIAMENTOSCRIPTST [Jul 17 16:51:26 2014]
...
\midrule
MaaP::Server::ModelServer::DataManager::DatabaseManager
& RDF10.2\\
& RDF10.2.1\\
& RDF10.2.1.1\\
& RDF10.2.1.2\\
...
\midrule
RDF11
& L'utente business autenticato può effettuare la ricerca di una Collection attraverso la barra di ricerca
& MaaP::Client::ControllerModelView ::ControllerClient::DashboardCtrl\\
...
\midrule
RDF10.6.3
& L'utente business autenticato amministratore deve poter visualizzare il comando per la creazione dell'indice da riga di comando
& MaaP::Client::ControllerModelView ::ControllerClient::QueryCtrl\\
