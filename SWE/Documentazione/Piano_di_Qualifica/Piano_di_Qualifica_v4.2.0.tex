...
\begin{itemize}
\item \grassetto{Funzionalità}: il prodotto software deve soddisfare tutti i requisiti funzionali, tutti i requisiti obbligatori trovati e di conseguenza fornire le funzionalità attese;
\begin{itemize}
